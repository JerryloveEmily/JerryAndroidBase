 ...
 */
package com.jerry.androidbaselibrary.widget.quickadapter;
...
public abstract class EnhancedQuickAdapter<T> extends QuickAdapter<T> {
    ...
    protected final void convert(BaseAdapterHelper helper, int position, T item) {
        ...
        convert(helper, position, item, itemChanged);
    }
     ...
     */
    protected abstract void convert(BaseAdapterHelper helper, int position, T item, boolean itemChanged);
}
